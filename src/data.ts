...
export const EXPERIENCES: ExperienceItem[] = [
  ...
  },
  {
    ...
    desc: {
      es: "Asumí responsabilidades de ingeniería de procesos tras quedar vacante el puesto, liderando el lanzamiento y estabilización de líneas de producción de Alcatel:<br/>● <strong>Alcatel 4007 (+17% producción) y Alcatel 4015 (+10% producción):</strong> Rediseñé el balanceo de línea y optimicé ergonomía de puestos, eliminando cuellos de botella y superando metas de First Pass Yield.<br/>● <strong>Capacitación en lanzamientos (-2 días onboarding):</strong> Diseñé e implementé programa de coaching peer-to-peer 1-a-1 entre turnos, alcanzando calidad requerida desde el primer día.<br/>● <strong>Estabilización de líneas de ensamble:</strong> Implementé pautas de balanceo continuo, tiempos de ciclo estándar y mejoras ergonómicas, manteniendo alta confiabilidad en líneas de telefonía móvil.",
      en: "Assumed process engineering responsibilities after the Process Engineer position became vacant, managing the launch and stabilization of Alcatel production lines:<br/>● <strong>Alcatel 4007 (+17% prod) & Alcatel 4015 (+10% prod):</strong> Redesigned line balancing and workstation ergonomics, eliminating bottlenecks and exceeding First Pass Yield targets.<br/>● <strong>Launch training model (-2 days onboarding):</strong> Designed and implemented a peer-to-peer 1-on-1 cross-shift coaching program, achieving full required quality from day one.<br/>● <strong>Assembly line stabilization:</strong> Implemented continuous balancing guidelines, standard cycle times, and ergonomic improvements, sustaining high reliability across mobile phone lines.",
      pt: "Assumi responsabilidades de engenharia de processos após o cargo ficar em aberto, liderando o lançamento e estabilização de linhas de produção da Alcatel:<br/>● <strong>Alcatel 4007 (+17% prod) e Alcatel 4015 (+10% prod):</strong> Redesenhei o balanceamento de linha e otimizei ergonomia de postos, eliminando gargalos e superando metas de First Pass Yield.<br/>● <strong>Treinamento em lançamentos (-2 dias onboarding):</strong> Desenvolvi e implementei programa peer-to-peer 1-a-1 entre turnos, atingindo padrão de qualidade logo no início.<br/>● <strong>Estabilização de linhas de montagem:</strong> Implementei diretrizes de balanceamento contínuo, tempos de ciclo padrão e melhorias ergonômicas, mantendo alta confiabilidade nas linhas de telefonia móvel."
    },
    highlight: { 
      es: "Lanzamiento Alcatel 4007 & 4015 · +17% producción · Balanceo de línea", 
      en: "Alcatel 4007 & 4015 Launch · +17% production · Line balancing", 
      pt: "Lançamento Alcatel 4007 & 4015 · +17% produção · Balanceamento" 
    }
  },
  {
    id: "e6",
