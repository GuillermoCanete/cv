...
export const EXPERIENCES: ExperienceItem[] = [
  ...
  },
  {
    ...
    desc: {
      es: "Asumí responsabilidades de ingeniería de procesos tras quedar vacante el puesto, liderando el lanzamiento y estabilización de líneas de producción de Alcatel y marcas globales:<br/>● <strong>Alcatel 4007 (+17% prod) y Alcatel 4015 (+10% prod):</strong> Rediseñé el balanceo de línea y optimicé ergonomía de puestos, eliminando cuellos de botella y superando metas de First Pass Yield.<br/>● <strong>Línea Microondas Samsung (-3 puestos operarios):</strong> Analicé tiempos de ciclo y redistribuí tareas estándar, reduciendo costos de mano de obra sin comprometer confiabilidad.<br/>● <strong>Capacitación en lanzamientos (-2 días onboarding):</strong> Diseñé e implementé programa de coaching peer-to-peer 1-a-1 entre turnos, alcanzando calidad requerida desde el primer día.<br/>● <strong>Especificaciones de marcas globales:</strong> Implementé APQP, PFMEA y Planes de Control, coordinando con proveedores en China la resolución de no conformidades para 5+ marcas globales.",
      en: "Assumed process engineering responsibilities after the Process Engineer position became vacant, managing the launch and stabilization of Alcatel and global brand production lines:<br/>● <strong>Alcatel 4007 (+17% prod) & Alcatel 4015 (+10% prod):</strong> Redesigned line balancing and workstation ergonomics, eliminating bottlenecks and exceeding First Pass Yield targets.<br/>● <strong>Samsung Microwave line (-3 operator roles):</strong> Analyzed cycle times and reallocated standard work, lowering manufacturing labor costs without compromising reliability.<br/>● <strong>Launch training model (-2 days onboarding):</strong> Designed and implemented a peer-to-peer 1-on-1 cross-shift coaching program, achieving full required quality from day one.<br/>● <strong>Global brand technical compliance:</strong> Implemented APQP, PFMEA, and Control Plans, coordinating component quality resolutions directly with suppliers in China for 5+ global brands.",
      pt: "Assumi responsabilidades de engenharia de processos após o cargo ficar em aberto, liderando o lançamento e a estabilização de linhas de produção da Alcatel e marcas globais:<br/>● <strong>Alcatel 4007 (+17% prod) e Alcatel 4015 (+10% prod):</strong> Redesenhei o balanceamento de linha e otimizei ergonomia de postos, eliminando gargalos e superando metas de First Pass Yield.<br/>● <strong>Linha Micro-ondas Samsung (-3 postos):</strong> Analisei tempos de ciclo e redistribuí tarefas padrão, reduzindo custos sem comprometer a confiabilidade.<br/>● <strong>Treinamento em lançamentos (-2 dias onboarding):</strong> Desenvolvi e implementei programa peer-to-peer 1-a-1 entre turnos, atingindo padrão de qualidade logo no início.<br/>● <strong>Conformidade de marcas globais:</strong> Implementei APQP, PFMEA e Planos de Controle, coordenando com fornecedores na China a resolução de não conformidades para 5+ marcas globais."
    },
    highlight: { 
